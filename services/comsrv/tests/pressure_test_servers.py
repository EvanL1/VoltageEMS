...
class ModbusPressureServer:
    ...
    def create_enhanced_datastore(self):
        ...
        for i in range(0, 498, 2):  # Changed from 500 to 498 to prevent overflow
        ...
        for i in range(0, 248, 2):  # Changed from 500 to 248 to fit within remaining 250 registers
