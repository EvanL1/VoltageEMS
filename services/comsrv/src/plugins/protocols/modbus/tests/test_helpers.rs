...
impl TestConfigBuilder {
    ...
    pub fn build_tcp_config(self) -> crate::plugins::protocols::modbus::common::ModbusConfig {
        crate::plugins::protocols::modbus::common::ModbusConfig {
