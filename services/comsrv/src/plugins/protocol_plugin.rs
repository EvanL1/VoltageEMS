...
macro_rules! protocol_plugin {
    (
        ...
        impl PluginMetadataImpl {
            pub fn metadata() -> $crate::plugins::protocol_plugin::ProtocolMetadata {
                $crate::plugins::protocol_plugin::ProtocolMetadata {
                    id: $id.to_string(),
                    name: $name.to_string(),
            ...
            pub fn config_template() -> Vec<$crate::plugins::protocol_plugin::ConfigTemplate> {
                vec![
    ...
    (@config_item {
        ...
        $crate::plugins::protocol_plugin::ConfigTemplate {
            name: $name.to_string(),
            description: $description.to_string(),
    ...
    (@validation { $($field:ident: $value:expr),* }) => {
        Some($crate::plugins::protocol_plugin::ValidationRule {
            $(
