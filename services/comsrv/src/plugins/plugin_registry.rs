...
pub mod discovery {
    ...
    fn register_builtin_plugins() -> Result<()> {
        ...
        {
            use crate::plugins::protocols::iec60870::plugin::Iec104Plugin;
        ...
        {
            use crate::plugins::protocols::can::plugin::CanPlugin;
        ...
        {
            use crate::plugins::protocols::virt::plugin::VirtualPlugin;
...
macro_rules! register_plugin {
    ($plugin_type:ty) => {
        ...
        fn register() {
            ...
            let _ = $crate::plugins::plugin_registry::PluginRegistry::register_global(plugin);
        }
    };
}
