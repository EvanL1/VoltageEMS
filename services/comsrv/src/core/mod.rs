...
"#;
        ...
        assert!(config_manager.is_ok(), "Should be able to create config manager from core module");
    ...
    fn test_protocols_module_access() {
        ...
        // Test error types
        let error = BaseCommError::connection("test error");
    ...
    #[test]
    fn test_metrics_module_access() {
        // Test that metrics components are accessible
        ...
        let data_point = DataPoint::new(
            ...
            "42.0".to_string(),
            100,
            "Test data point".to_string(),
        );
        
        assert_eq!(data_point.id, "test_point");
        assert_eq!(data_point.value, "42.0");
        assert_eq!(data_point.quality, 100);
        assert_eq!(data_point.description, "Test data point");
    }

    #[test]
    fn test_monitoring_module_access() {
        // Test that monitoring components are accessible
        // This serves as a compilation check
        assert!(true, "Monitoring module is accessible");
    }
    ...
    fn test_module_re_exports() {
        ...
        let _ = BaseCommStats::new();
        let _ = BaseCommError::connection("test");
...
"#;
        ...
        let mut factory = protocols::common::ProtocolFactory::new();
