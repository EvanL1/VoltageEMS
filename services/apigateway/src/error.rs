...
impl fmt::Display for ApiGatewayError {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            ...
            ApiGatewayError::ConfigChecksumError => write!(f, "Config checksum verification failed"),
            ApiGatewayError::ConfigSubscriptionError(msg) => write!(f, "Config subscription error: {}", msg),
        }
    }
}
...
impl ResponseError for ApiGatewayError {
    fn error_response(&self) -> HttpResponse {
        let (status, code) = match self {
            ApiGatewayError::ServiceUnavailable(_) => (StatusCode::SERVICE_UNAVAILABLE, "SERVICE_UNAVAILABLE"),
            ...
            ApiGatewayError::MethodNotAllowed => (StatusCode::METHOD_NOT_ALLOWED, "METHOD_NOT_ALLOWED"),
            
            ApiGatewayError::InternalError(_) => (StatusCode::INTERNAL_SERVER_ERROR, "INTERNAL_ERROR"),
            ApiGatewayError::DatabaseError(_) => (StatusCode::INTERNAL_SERVER_ERROR, "DATABASE_ERROR"),
            ApiGatewayError::RedisError(_) => (StatusCode::INTERNAL_SERVER_ERROR, "REDIS_ERROR"),
            
            ApiGatewayError::ConfigFetchError(_) => (StatusCode::INTERNAL_SERVER_ERROR, "CONFIG_FETCH_ERROR"),
            ApiGatewayError::ConfigParseError(_) => (StatusCode::INTERNAL_SERVER_ERROR, "CONFIG_PARSE_ERROR"),
            ApiGatewayError::ConfigUpdateError(_) => (StatusCode::INTERNAL_SERVER_ERROR, "CONFIG_UPDATE_ERROR"),
            ApiGatewayError::ConfigChecksumError => (StatusCode::INTERNAL_SERVER_ERROR, "CONFIG_CHECKSUM_ERROR"),
            ApiGatewayError::ConfigSubscriptionError(_) => (StatusCode::INTERNAL_SERVER_ERROR, "CONFIG_SUBSCRIPTION_ERROR"),
        };
