export default {
  ...
  auditLogs: {
    ...
    exportConfirm: 'Are you sure to export audit logs?',
    clearConfirm: 'This operation will clear all audit logs and cannot be recovered! Please proceed with caution.',
    clearDoubleConfirm: 'Please type CLEAR to confirm the clearing operation',
    clearInputError: 'Please enter the correct confirmation text',
    clearSuccess: 'Clear successful',
    onlyViewOwn: 'Operations engineers can only view their own operation logs',
    modules: {
      all: 'All',
      auth: 'Auth',
      config: 'Config',
